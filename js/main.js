(function($) {	
	...
	var de_boxed_style = 0; 
	var de_header_style = 2; 
	var de_header_color = 1; 
	var de_header_color_scroll = 2; 
	var de_menu_separator = 0; 
	var	smoothscroll = 0;
	...
	function load_magnificPopup() {
		...
		$('.images-group').each(function() {
			$(this).magnificPopup({
				delegate: 'a', // the selector for event item
				type: 'image',
				gallery: {
				  enabled:true
				}
